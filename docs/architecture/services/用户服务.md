...
| 方法 | 路径 | 说明 | 请求 | 响应 | 角色 |
|------|------|------|------|------|------|
| POST | /api/v1/user/register | 注册 | RegisterReq | RegisterResp | 公开 |
| GET | /api/v1/user/profile | 查询资料 | - | UserProfile | customer |
| PUT | /api/v1/user/profile | 更新资料 | UpdateProfileReq | UserProfile | customer |
| GET | /api/v1/user/addresses | 地址列表 | - | AddressListResp | customer |
| POST | /api/v1/user/addresses | 添加地址 | AddressCreateReq | AddressCreateResp | customer |
| PUT | /api/v1/user/addresses/:id | 更新地址 | AddressUpdateReq | UserAddress | customer |
| DELETE | /api/v1/user/addresses/:id | 删除地址 | AddressDeleteReq | - | customer |
