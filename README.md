...
完整交付入口见[产品与测试交付包](docs/delivery/README.md)：4 册核心 PDF、4 册配套 PDF、66 个测试场景、22 项需求追踪与执行 / 缺陷模板。新增正文位于 `docs/delivery/`，核心 PDF 位于 `output/pdf/交付套件/`，可分发整包位于 `output/delivery/`。测试场景初始均为未执行。
